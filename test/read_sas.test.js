const { initWebR, read_sas, read_xpt, read_sas_size, read_xpt_size } = require('../src/read_dataset');
...
initWebR()
   ...
   .then(async () => {console.log('dm first 8 rows, 2cols:', await read_sas(path.join(__dirname, "dm.sas7bdat"), `AGE <= 60 & SEX == 'M'`, '.(USUBJID, AGE, SEX)'));})    
